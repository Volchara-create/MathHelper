...
{title:'Радіус описаного кола',formula:'R = (a·b·c) / (4·S)',svg:'<polygon points="60,175 240,175 130,40" fill="#eef4ff" stroke="#1a3e7c" stroke-width="2.5"/><circle cx="145" cy="118" r="72" fill="none" stroke="#ff6b6b" stroke-width="2.5" stroke-dasharray="8,4"/><circle cx="145" cy="118" r="4" fill="#ff6b6b"/><line x1="145" y1="118" x2="217" y2="118" stroke="#ff6b6b" stroke-width="1.8"/><text x="181" y="110" font-size="14" fill="#ff6b6b" font-weight="bold">R</text><text x="150" y="195" text-anchor="middle" font-size="14" fill="#1a3e7c" font-weight="bold">a</text><text x="82" y="115" font-size="14" fill="#1a3e7c" font-weight="bold">b</text><text x="198" y="115" font-size="14" fill="#1a3e7c" font-weight="bold">c</text>',symbols:[{s:'R',m:'Радіус описаного кола'},{s:'a,b,c',m:'Три сторони трикутника'},{s:'S',m:'Площа трикутника'}],detail:{explanation:'Радіус кола, описаного навколо трикутника. Центр знаходиться на перетині серединних перпендикулярів до сторін.',proof:'З теореми синусів: a/sin(A) = 2R\nЗвідси R = a/(2·sin(A))\nЗ формули площі S = ½·a·b·sin(C) виводимо sin(C) = 2S/(a·b)\nПідставляємо: R = (a·b·c)/(4S)',example:'Трикутник: a=5, b=6, c=7\nS = √(9·4·3·2) = 6√6 ≈ 14.7\nR = (5·6·7)/(4·14.7) ≈ 210/58.8 ≈ 3.57'}}
],
cube:[
