...
<ul style="margin:8px 0 8px 20px;line-height:2">
  ...
  },
  {
    ...
    meta: '7 клас · §8–§11 · Одночлени і многочлени',
    type: 'test',
    theory: `<p>Перевір знання §8–§11. Без підказок!</p>
<p>Теми: одночлен і його стандартний вигляд · множення одночленів · многочлен · додавання і віднімання многочленів</p>`,
    practice: [
...
const TB_CHAPTERS = [
  ...
  },
  {
    ...
    color: '#0369a1',
    lessons: ['expressions-variables', 'identities', 'powers', 'power-properties', 'test-ch2-p1', 'monomial-standard', 'monomial-multiply', 'polynomial-def', 'polynomial-add-sub', 'test-ch3']
  }
];
