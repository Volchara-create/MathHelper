...
,
  {
    ...
    examples: [
      {
            "q": "Знайдіть допустимі значення для виразу 5 / (x - 4)",
            "steps": [
                  "Крок 1: Знаменник дробу — це вираз (x - 4).",
                  "Крок 2: Знайдемо, коли знаменник стає нулем: x - 4 = 0, звідси x = 4.",
                  "Крок 3: Оскільки ділити на нуль не можна, x не може бути рівним 4.",
                  "Відповідь: Усі числа, крім 4."
            ]
      },
      {
            "q": "Визначте вид виразу: (a + 2) / 8",
            "steps": [
                  "Крок 1: Дивимося на знаменник дробу. Там стоїть число 8.",
                  "Крок 2: Оскільки в знаменнику немає змінної (букви), цей вираз не є дробовим.",
                  "Відповідь: Цілий вираз."
            ]
      }
],
    practice: [
      {
            "q": "Який із виразів є дробовим: 1) x / 7 чи 2) 7 / x? Вкажіть цифру.",
            "ans": "2",
            "altAns": [
                  "2)"
            ],
            "hint": "Дробовий вираз обов'язково має ділення на змінну (букву) у знаменнику."
      },
      {
            "q": "При якому значенні x вираз 3 / (x - 8) не має змісту?",
            "ans": "8",
            "altAns": [
                  "x=8"
            ],
            "hint": "Вираз не має змісту, коли його знаменник стає рівним нулю."
      },
      {
            "q": "Яке число НЕ є допустимим значенням для змінної a у виразі 1 / (a + 10)?",
            "ans": "-10",
            "altAns": [
                  "a=-10"
            ],
            "hint": "Знайдіть число, яке при додаванні до 10 перетворить знаменник на нуль."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Скоротіть дріб: 6a³b² / 24a²b⁴",
            "steps": [
                  "Крок 1: Знайдемо спільний множник для чисельника і знаменника. Це 6a²b².",
                  "Крок 2: Поділимо чисельник на цей множник: 6a³b² ÷ 6a²b² = a.",
                  "Крок 3: Поділимо знаменник: 24a²b⁴ ÷ 6a²b² = 4b².",
                  "Відповідь: a/4b²"
            ]
      },
      {
            "q": "Скоротіть дріб: (4a - 20) / (5a - a²)",
            "steps": [
                  "Крок 1: Винесемо спільні множники: 4(a - 5) / a(5 - a).",
                  "Крок 2: Бачимо, що (a - 5) та (5 - a) — протилежні вирази. Змінимо знак у знаменнику: -a(a - 5).",
                  "Крок 3: Скоротимо на (a - 5).",
                  "Відповідь: -4/a"
            ]
      }
],
    practice: [
      {
            "q": "Скоротіть дріб: 15x³ / 5x²",
            "ans": "3x",
            "altAns": [
                  "3x/1"
            ],
            "hint": "Поділи числа (15÷5) та степені змінних (x³÷x²)."
      },
      {
            "q": "Спростіть вираз: (x - y) / (y - x)",
            "ans": "-1",
            "altAns": [],
            "hint": "Вирази в чисельнику і знаменнику відрізняються лише знаком. Винеси мінус за дужки."
      },
      {
            "q": "Скоротіть дріб: (a + 2) / (a² + 2a)",
            "ans": "1/a",
            "altAns": [
                  "1/a"
            ],
            "hint": "Винеси спільний множник 'a' у знаменнику за дужки, а потім скороти однакові вирази."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Виконайте віднімання: (7x - 5) / 8x² - (3x - 5) / 8x²",
            "steps": [
                  "Крок 1: Записуємо чисельники під одну риску дробу: (7x - 5 - (3x - 5)) / 8x²",
                  "Крок 2: Розкриваємо дужки, змінюючи знаки: (7x - 5 - 3x + 5) / 8x²",
                  "Крок 3: Зводимо подібні доданки: 4x / 8x²",
                  "Крок 4: Скорочуємо на 4x та отримуємо відповідь: 1 / 2x"
            ]
      },
      {
            "q": "Спростіть вираз: a² / (a - 3) - 9 / (a - 3)",
            "steps": [
                  "Крок 1: Віднімаємо чисельники при спільному знаменнику: (a² - 9) / (a - 3)",
                  "Крок 2: Розкладаємо чисельник за формулою різниці квадратів: (a - 3)(a + 3) / (a - 3)",
                  "Крок 3: Скорочуємо на (a - 3) та отримуємо відповідь: a + 3"
            ]
      }
],
    practice: [
      {
            ...
            "hint": "Просто додай чисельники m та 4m, а знаменник n залиш без змін."
      },
      {
            "q": "6c/d - 2c/d",
            "ans": "4c/d",
            ...
            "hint": "Відніми чисельники: 6c - 2c = 4c."
      },
      {
            "q": "x²/(x+1) - 1/(x+1)",
            "ans": "x-1",
            ...
            "hint": "Після віднімання вийде (x²-1)/(x+1). Розклади x²-1 як (x-1)(x+1) та скороти дріб."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Спростіть (b+1)/abc + (1-a)/a²c",
            "steps": [
                  "Крок 1: Спільний знаменник для abc та a²c — це a²bc.",
                  "Крок 2: Додатковий множник для першого дробу — a, для другого — b.",
                  "Крок 3: (a(b+1) + b(1-a)) / a²bc = (ab + a + b - ab) / a²bc.",
                  "Відповідь: (a+b)/a²bc"
            ]
      },
      {
            "q": "Спростіть x/(x-4) - (x+2)/(x-2)",
            "steps": [
                  "Крок 1: Спільний знаменник — це добуток (x-4)(x-2).",
                  "Крок 2: x(x-2) - (x+2)(x-4) / (x-4)(x-2).",
                  "Крок 3: Після розкриття дужок у чисельнику: x²-2x-(x²-2x-8) = 8.",
                  "Відповідь: 8/((x-4)(x-2))"
            ]
      }
],
    practice: [
      {
            ...
            "hint": "Зведіть до спільного знаменника 12."
      },
      {
            "q": "5b/14 - b/7",
            "ans": "3b/14",
            ...
            "hint": "Спільний знаменник 14. Помножте другий дріб на 2."
      },
      {
            "q": "4/x - 3/y",
            "ans": "(4y-3x)/xy",
            ...
            "hint": "Спільний знаменник — добуток x та y."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Спростіть вираз: (21c⁶ / b⁸) × (b² / 14c⁴)",
            "steps": [
                  "Крок 1: Записуємо все під одну риску дробу: (21c⁶ × b²) / (b⁸ × 14c⁴)",
                  "Крок 2: Скорочуємо числа 21 та 14 на 7. Отримуємо 3 у чисельнику та 2 у знаменнику.",
                  "Крок 3: Скорочуємо степені: c⁶ та c⁴ дають c² вгорі, а b² та b⁸ дають b⁶ внизу.",
                  "Відповідь: 3c² / 2b⁶"
            ]
      },
      {
            "q": "Виконайте ділення: (a² - 2ab) / (a + 9) ÷ (a² - 4b²) / (3a + 27)",
            "steps": [
                  "Крок 1: Замінюємо ділення на множення, перевернувши другий дріб: (a²-2ab)/(a+9) × (3a+27)/(a²-4b²)",
                  "Крок 2: Розкладаємо все на множники: a(a-2b)/(a+9) × 3(a+9)/((a-2b)(a+2b))",
                  "Крок 3: Скорочуємо однакові дужки (a-2b) та (a+9).",
                  "Відповідь: 3a / (a + 2b)"
            ]
      }
],
    practice: [
      {
            "q": "Обчисліть: (7a / b) × (b / a)",
            "ans": "7",
            "altAns": [],
            "hint": "При множенні однакові букви зверху і знизу можна просто закреслити (скоротити)."
      },
      {
            "q": "Спростіть: (x² / 5) ÷ (x / 10)",
            "ans": "2x",
            "altAns": [
                  "2*x"
            ],
            "hint": "Переверни другий дріб: вийде (x²/5) * (10/x). Тепер скороти 10 на 5 та x² на x."
      },
      {
            "q": "Піднесіть до квадрата: (3 / c)²",
            "ans": "9/c²",
            "altAns": [
                  "9/c^2"
            ],
            "hint": "Піднеси до другого степеня окремо трійку (3*3) та окремо букву c."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Спростіть вираз: (3a/(a-2) - 6a/(a-2)²) ÷ (a-4)/(a²-4) - (2a²+8a)/(a-2)",
            "steps": [
                  "Крок 1: Обчислюємо в дужках. Спільний знаменник (a-2)². Отримуємо 3a(a-4)/(a-2)².",
                  "Крок 2: Виконуємо ділення. Перевертаємо дріб і скорочуємо на (a-4) та (a-2). Отримуємо 3a(a+2)/(a-2).",
                  "Крок 3: Віднімання. Знаменники однакові, тому (3a²+6a - 2a² - 8a)/(a-2) = (a²-2a)/(a-2).",
                  "Відповідь: a"
            ]
      },
      {
            "q": "Доведіть, що значення виразу (3a/(a+3) + a²/(a²-9) ÷ a/(a-3)) не залежить від a",
            "steps": [
                  "Крок 1: Виконуємо ділення: (a²/(a-3)(a+3)) × (a-3)/a = a/(a+3).",
                  "Крок 2: Додаємо: 3a/(a+3) + a/(a+3) = 4a/(a+3).",
                  "Відповідь: Значення залежить від a (приклад спрощення)."
            ]
      }
],
    practice: [
      {
            "q": "Розв'яжіть рівняння: (2x+3)² - 2x(5+2x) = 10",
            "ans": "0.5",
            "altAns": [
                  "1/2",
                  "0,5"
            ],
            "hint": "Розкрийте дужки: 4x²+12x+9 - 10x-4x² = 10"
      },
      {
            "q": "Спростіть вираз: (a/b + 1) ÷ (a+b)/b",
            "ans": "1",
            "altAns": [],
            "hint": "Зведіть до спільного знаменника в дужках: (a+b)/b"
      },
      {
            "q": "Спростіть вираз: (x²-1)/(x-1) - x",
            "ans": "1",
            "altAns": [],
            "hint": "Розкладіть різницю квадратів: (x-1)(x+1)"
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Чи є рівносильними рівняння x² = 1 та (x - 1)(x + 1) = 0?",
            "steps": [
                  "Крок 1: Розв'яжемо x² = 1. Корені: 1 та -1.",
                  "Крок 2: Розв'яжемо (x - 1)(x + 1) = 0. Корені: 1 та -1.",
                  "Відповідь: Так, рівняння рівносильні, бо мають однакові корені."
            ]
      },
      {
            "q": "Розв'яжіть рівняння (x - 1)(x + 1) / (x² - 4x + 3) = 0",
            "steps": [
                  "Крок 1: Прирівняємо чисельник до нуля: (x - 1)(x + 1) = 0. Маємо корені 1 та -1.",
                  "Крок 2: Перевіримо знаменник. Якщо x = 1, знаменник 1² - 4·1 + 3 = 0. Це число не підходить.",
                  "Крок 3: Якщо x = -1, знаменник (-1)² - 4·(-1) + 3 = 8 (не нуль). Це число підходить.",
                  "Відповідь: -1"
            ]
      }
],
    practice: [
      {
            "q": "Розв'яжіть рівняння: (x - 7) / x = 0",
            "ans": "7",
            "altAns": [],
            "hint": "Чисельник має дорівнювати 0, а знаменник не може бути нулем."
      },
      {
            "q": "Розв'яжіть рівняння: (x + 3)(x - 4) / (x - 4) = 0",
            "ans": "-3",
            "altAns": [],
            "hint": "Знайдіть корені чисельника, але відкиньте той, що робить знаменник нулем."
      },
      {
            "q": "Розв'яжіть рівняння: (x² - 4) / (x - 2) = 0",
            "ans": "-2",
            "altAns": [],
            "hint": "Чисельник дорівнює нулю при 2 та -2. Перевірте, чи не занулює знаменник число 2."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Обчисліть значення виразу 2⁻³",
            "steps": [
                  "Крок 1: За формулою a⁻ⁿ = 1 / aⁿ запишемо вираз як дріб: 1 / 2³",
                  "Крок 2: Обчислимо знаменник: 2³ = 2 * 2 * 2 = 8",
                  "Відповідь: 1/8"
            ]
      },
      {
            "q": "Знайдіть значення (-5)⁻²",
            "steps": [
                  "Крок 1: Запишемо у вигляді дробу: 1 / (-5)²",
                  "Крок 2: Оскільки показник парний (2), мінус зникне: (-5) * (-5) = 25",
                  "Відповідь: 1/25"
            ]
      }
],
    practice: [
      ...
      },
      {
            ...
            "hint": "Будь-яке число в степені -1 — це 1, поділена на це число"
      },
      {
            "q": "Чому дорівнює (-2)⁻³?",
            "ans": "-1/8",
            ...
            "hint": "Спочатку обчисли (-2)³, а потім запиши 1 поділити на цей результат"
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Спростіть вираз a⁻¹⁴ · a¹²",
            "steps": [
                  "Крок 1: При множенні основ показники степенів додаються.",
                  "Крок 2: Обчислимо суму: -14 + 12 = -2.",
                  "Відповідь: a⁻²"
            ]
      },
      {
            "q": "Спростіть вираз a⁻⁵ ÷ a⁻⁹",
            "steps": [
                  "Крок 1: При діленні показник дільника віднімається від показника діленого.",
                  "Крок 2: Обчислимо різницю: -5 - (-9) = -5 + 9 = 4.",
                  "Відповідь: a⁴"
            ]
      }
],
    practice: [
      ...
      },
      {
            ...
            "hint": "При піднесенні степеня до степеня показники перемножуються: -3 · (-2)"
      },
      {
            "q": "a⁻⁵ ÷ a⁻³",
            "ans": "a^-2",
            ...
            "hint": "Відніми показники: -5 - (-3) = -5 + 3"
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Прямокутник має площу 18 см². Задайте формулою залежність сторони y від сторони x.",
            "steps": [
                  "Крок 1: Площа прямокутника обчислюється за формулою S = x · y.",
                  "Крок 2: Виразимо сторону y: y = S/x.",
                  "Крок 3: Підставимо відоме значення площі (18) у формулу.",
                  "Відповідь: y = 18/x"
            ]
      },
      {
            "q": "Чи проходить графік функції y = 12/x через точку A(-2; -6)?",
            "steps": [
                  "Крок 1: Підставимо координати точки в рівняння: x = -2, y = -6.",
                  "Крок 2: Перевіримо рівність: -6 = 12 / (-2).",
                  "Крок 3: Обчислимо праву частину: 12 / (-2) = -6.",
                  "Відповідь: Так, оскільки -6 = -6"
            ]
      }
],
    practice: [
      {
            "q": "Знайдіть значення функції y = 20/x, якщо x = 5.",
            "ans": "4",
            "altAns": [],
            "hint": "Підстав замість x число 5 і виконай ділення: 20 ÷ 5"
      },
      {
            "q": "При якому значенні x функція y = 14/x набуває значення 2?",
            "ans": "7",
            "altAns": [],
            "hint": "Розв'яжи рівняння 14/x = 2. Подумай, на що треба поділити 14, щоб отримати 2"
      },
      {
            "q": "Знайдіть коефіцієнт k для функції y = k/x, якщо її графік проходить через точку (3; 4).",
            "ans": "12",
            "altAns": [],
            "hint": "Підстав x=3 та y=4 у формулу. Щоб знайти k, потрібно помножити x на y"
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Чи проходить графік функції y = x² через точку A(-5; 25)?",
            "steps": [
                  "Крок 1: Підставимо x = -5 у формулу y = x².",
                  "Крок 2: Обчислимо: (-5)² = (-5) · (-5) = 25.",
                  "Крок 3: Порівняємо результат із заданим значенням y. Оскільки 25 = 25, точка належить графіку.",
                  "Відповідь: Так"
            ]
      },
      {
            "q": "Розв'яжіть графічно рівняння x² = x + 2",
            "steps": [
                  "Крок 1: Побудуємо параболу y = x² та пряму y = x + 2 в одній системі координат.",
                  "Крок 2: Знайдемо точки, де ці графіки перетинаються: це (-1; 1) та (2; 4).",
                  "Крок 3: Коренями рівняння є абсциси (значення x) цих точок: -1 та 2.",
                  "Відповідь: -1; 2"
            ]
      }
],
    practice: [
      {
            "q": "Знайдіть значення y, якщо x = -0,6 для функції y = x²",
            "ans": "0,36",
            "altAns": [
                  "0.36",
                  ",36",
            ...
            "hint": "Піднеси -0,6 до квадрата: (-0,6) · (-0,6)"
      },
      {
            "q": "При якому додатному значенні x значення функції y = x² дорівнює 49?",
            "ans": "7",
            "altAns": [
                  "+7"
            ],
            "hint": "Яке додатне число при множенні на себе дає 49?"
      },
      {
            "q": "Точка M(x; 81) належить графіку y = x². Знайдіть від’ємне значення x.",
            "ans": "-9",
            "altAns": [],
            "hint": "Яке від’ємне число при піднесенні до квадрата дає 81?"
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Знайдіть сторону квадрата, площа якого дорівнює 25 см²",
            "steps": [
                  "Крок 1: Площа квадрата обчислюється за формулою S = a².",
                  "Крок 2: Нам потрібно знайти число, квадрат якого дорівнює 25. Це √25.",
                  "Відповідь: 5 см."
            ]
      },
      {
            "q": "Обчисліть √0,04",
            "steps": [
                  "Крок 1: Шукаємо невід'ємне число, яке при множенні на себе дає 0,04.",
                  "Крок 2: Оскільки 0,2 × 0,2 = 0,04, то корінь дорівнює 0,2.",
                  "Відповідь: 0,2."
            ]
      }
],
    practice: [
      {
            ...
            "ans": "7",
            "altAns": [],
            "hint": "Яке число при множенні на себе дає 49?"
      },
      {
            "q": "Обчисліть √1600",
            "ans": "40",
            "altAns": [],
            "hint": "Підказка: √16 = 4, а у відповіді буде вдесятеро більше число."
      },
      {
            "q": "Знайдіть сторону квадрата, площа якого 0,81 м²",
            "ans": "0,9",
            "altAns": [
                  "0.9"
            ],
            "hint": "Знайдіть число, квадрат якого дорівнює 0,81. Спробуйте 0,9."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Запишіть множину букв слова «космодром»",
            "steps": [
                  "Крок 1: Випишемо всі букви, що є у слові: к, о, с, м, о, д, р, о, м.",
                  "Крок 2: У множині кожен елемент записується лише один раз. Викреслимо повтори: к, о, с, м, д, р.",
                  "Відповідь: {к, о, с, м, д, р}"
            ]
      },
      {
            "q": "Чи рівні множини A = {1, 2, 3} та B = {3, 1, 2}?",
            "steps": [
                  "Крок 1: Перевіримо, чи кожен елемент множини A є у множині B (так: 1, 2, 3).",
                  "Крок 2: Перевіримо, чи кожен елемент множини B є у множині A (так: 3, 1, 2).",
                  "Крок 3: Оскільки склад елементів однаковий, множини рівні, попри інший порядок.",
                  "Відповідь: так"
            ]
      }
],
    practice: [
      {
            "q": "Скільки елементів у множині букв слова «алгебра»?",
            "ans": "6",
            "altAns": [
                  "6 елементів"
            ],
            "hint": "Випиши всі різні букви: а, л, г, е, б, р."
      },
      {
            "q": "Чи належить число 7 множині парних чисел?",
            "ans": "ні",
            "altAns": [
                  "не належить"
            ],
            "hint": "Парні числа діляться на 2 без остачі. Чи ділиться 7 на 2?"
      },
      {
            "q": "Запишіть через кому без пробілів множину цифр числа 2024.",
            "ans": "0,2,4",
            "altAns": [
                  "2,0,4",
                  "4,2,0",
            ...
            "hint": "Цифри у множині не мають повторюватися, цифра 2 зустрічається двічі, але пишемо її один раз."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "До яких множин належить число -5?",
            "steps": [
                  "Крок 1: Число -5 не є натуральним, бо ми не використовуємо його для лічби предметів.",
                  "Крок 2: Воно є цілим (Z), бо це від’ємне число без дробової частини.",
                  "Крок 3: Оскільки воно ціле, воно також є раціональним (Q).",
                  "Відповідь: Z, Q"
            ]
      },
      {
            "q": "Запишіть число 0,2 у вигляді звичайного дробу.",
            "steps": [
                  "Крок 1: Читаємо число: «дві десятих».",
                  "Крок 2: Записуємо як 2/10.",
                  "Крок 3: Скорочуємо на 2 і отримуємо 1/5.",
                  "Відповідь: 1/5"
            ]
      }
],
    practice: [
      {
            "q": "Яке з чисел є натуральним: -2, 0, 7 або 1.5?",
            "ans": "7",
            "altAns": [
                  "сім"
            ],
            "hint": "Натуральні числа починаються з 1 і йдуть далі: 1, 2, 3..."
      },
      {
            "q": "Чи є число -10 раціональним? (так/ні)",
            "ans": "так",
            "altAns": [
                  "так",
                  "є"
            ],
            "hint": "Усі цілі числа входять до множини раціональних чисел."
      },
      {
            "q": "Якою буквою позначають множину цілих чисел?",
            "ans": "Z",
            "altAns": [
                  "z"
            ],
            "hint": "Ця буква походить від німецького слова Zahlen (числа)."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Обчисліть √(-7.3)²",
            "steps": [
                  "Крок 1: Застосуємо властивість √a² = |a|.",
                  "Крок 2: Отримуємо |-7.3|.",
                  "Відповідь: 7.3"
            ]
      },
      {
            "q": "Знайдіть значення √0.81·225",
            "steps": [
                  "Крок 1: Розбиваємо на добуток коренів: √0.81 · √225.",
                  "Крок 2: Обчислюємо: 0.9 · 15.",
                  "Відповідь: 13.5"
            ]
      }
],
    practice: [
      {
            ...
            "ans": "12",
            "altAns": [],
            "hint": "Результат кореня завжди додатний, тому √(-12)² = |-12|."
      },
      {
            "q": "Знайдіть значення √4·25",
            "ans": "10",
            "altAns": [],
            "hint": "Обчисли окремо √4 та √25, а потім перемнож результати."
      },
      {
            "q": "Обчисліть √3 · √27",
            "ans": "9",
            "altAns": [],
            "hint": "Занеси обидва числа під один корінь: √(3 · 27)."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Винесіть множник з-під знака кореня: √150",
            "steps": [
                  "Крок 1: Розкладемо 150 на множники, один з яких квадрат: 150 = 25 · 6",
                  "Крок 2: Добудемо корінь з 25: √25 = 5",
                  "Відповідь: 5√6"
            ]
      },
      {
            "q": "Внесіть множник під знак кореня: 2√7",
            "steps": [
                  "Крок 1: Піднесемо множник 2 до квадрата: 2² = 4",
                  "Крок 2: Запишемо добуток під коренем: √(4 · 7)",
                  "Відповідь: √28"
            ]
      }
],
    practice: [
      {
            "q": "Винесіть множник з-під кореня: √12",
            "ans": "2√3",
            "altAns": [
                  "2*√3"
            ],
            "hint": "Розклади 12 на 4 · 3 і добуть корінь з 4"
      },
      {
            "q": "Внесіть множник під корінь: 3√2",
            "ans": "√18",
            "altAns": [
                  "sqrt(18)"
            ],
            "hint": "Піднеси 3 до квадрата (це 9) і помнож на 2 під коренем"
      },
      {
            "q": "Спростіть вираз: 5√2 + 3√2 - 2√2",
            "ans": "6√2",
            "altAns": [
                  "6*√2"
            ],
            "hint": "Порахуй коефіцієнти перед коренем: 5 + 3 - 2"
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Знайдіть значення функції y = √x, якщо x = 6.25",
            "steps": [
                  "Підставляємо значення x у формулу: y = √6.25",
                  "Згадуємо, яке число в квадраті дає 6.25: це 2.5",
                  "Відповідь: y = 2.5"
            ]
      },
      {
            "q": "Порівняйте числа 4 і √15",
            "steps": [
                  "Представимо число 4 як корінь: 4 = √16",
                  "Порівняємо підкореневі вирази: 16 > 15",
                  "Оскільки 16 > 15, то √16 > √15",
                  "Відповідь: 4 > √15"
            ]
      }
],
    practice: [
      {
            "q": "Знайдіть значення y, якщо x = 0.04",
            "ans": "0.2",
            "altAns": [
                  "0,2"
            ],
            "hint": "Обчисліть корінь з 0.04. Яке число при множенні на себе дає 0.04?"
      },
      {
            "q": "Знайдіть значення x, при якому y = 11",
            "ans": "121",
            "altAns": [],
            "hint": "Щоб знайти x, піднесіть y до квадрата: 11²."
      },
      {
            "q": "Чи проходить графік функції y = √x через точку (9; 3)? (так/ні)",
            "ans": "так",
            "altAns": [
                  "Так"
            ],
            "hint": "Перевірте, чи правильно, що √9 = 3."
      }
]
  },
  {
    ...
    examples: [
      {
            "q": "Розв'яжіть рівняння 3x² - 27 = 0",
            "steps": [
                  "Крок 1: Перенесемо число 27 у праву частину: 3x² = 27",
                  "Крок 2: Поділимо обидві частини на 3: x² = 9",
                  "Крок 3: Знайдемо корені (числа, квадрат яких 9): x = 3 або x = -3",
                  "Відповідь: 3; -3"
            ]
      },
      {
            "q": "Розв'яжіть рівняння 2x² + 10x = 0",
            "steps": [
                  "Крок 1: Винесемо спільний множник x за дужки: x(2x + 10) = 0",
                  "Крок 2: Добуток дорівнює нулю, якщо x = 0 або 2x + 10 = 0",
                  "Крок 3: Розв'яжемо друге рівняння: 2x = -10, отже x = -5",
                  "Відповідь: 0; -5"
            ]
      }
],
    practice: [
      {
            ...
            "hint": "Перенеси 49 вправо і подумай, які два числа у квадраті дають 49."
      },
      {
            "q": "7x² = 0",
            "ans": "0",
            "altAns": [],
            "hint": "Якщо добуток числа 7 та x² дорівнює нулю, то чому дорівнює сам x?"
      },
      {
            "q": "x² + 4x = 0",
            "ans": "0;-4",
            ...
            "hint": "Винеси x за дужки: x(x + 4) = 0. Перший корінь буде 0, а другий знайдеш із дужок."
      }
]
  }
];
...
const TB_CHAPTERS = [
  ...
  },
  {
    ...
    color: '#7c3aed',
    lessons: ['r8-quadratic-incomplete']
  }
];
