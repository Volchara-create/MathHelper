...
const MATHIK_TUTORIAL = [
  ...
  // ── 1. Летить до кнопки "Формули" на головній ──────────────
  {
    navigate: () => show('home'),
    target: '#dash-quick-btns button[onclick*="formulas"]',
    msg: '📚 <b>Ось кнопка Формул!</b><br>Натискаю — і ми потрапляємо всередину...'
  },
  // ── 2. Відкриває формули → летить до вкладки Алгебра ───────
  {
    navigate: () => show('formulas'),
    target: '#ftab-btn-algebra',
    msg: '📐 <b>Розділ Формули!</b><br>Вкладки вгорі: Алгебра, Геометрія, Тригонометрія. Обери клас → тему → натисни на формулу!'
  },
  ...
  // ── 4. Повертається → кнопка Квіз ──────────────────────────
  {
    navigate: () => { try { closeAlgebraModal(); } catch(e){} show('home'); },
    target: '#dash-quick-btns button[onclick*="quiz"]',
    msg: '🎯 <b>Ось кнопка Квізу!</b><br>Натискаю — зараз покажу...'
  },
  // ── 5. Відкриває квіз → летить до теми ─────────────────────
  {
    navigate: () => show('quiz'),
  ...
  // ── 6. НМТ кнопка в нижньому меню ──────────────────────────
  {
    target: 'a.qm-btn[href="simulator.html"]',
    msg: '📝 <b>НМТ Симулятор</b> — ось кнопка внизу!<br>30 питань, 90 хвилин — точно як на реальному НМТ. Після — розбір помилок.'
  },
  // ── 7. Пошук ────────────────────────────────────────────────
  {
    navigate: () => show('home'),
