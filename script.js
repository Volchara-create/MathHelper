...
<p>Цей спосіб застосовують і для <b>розв'язування рівнянь</b>, коли права частина = 0: добуток = 0 тоді і тільки тоді, коли хоча б один множник = 0.</p>`,
  ...
  },
  {
    ...
    meta: '7 клас · §8–§13 · Одночлени і многочлени',
    type: 'test',
    theory: `<p>Перевір знання §8–§13. Без підказок!</p>
<p>Теми: одночлен · множення одночленів · многочлен · додавання і віднімання · множення одночлена на многочлен · розкладання на множники</p>`,
    practice: [
      ...
      { q: 'Спрости: x(x + 2) − x(x − 2) = ?', ans: '4x', altAns: ['4x'] }
    ]
  },
  {
    id: 'equations-basics',
...
const TB_CHAPTERS = [
  ...
  },
  {
    ...
    color: '#0369a1',
    lessons: ['expressions-variables', 'identities', 'powers', 'power-properties', 'test-ch2-p1', 'monomial-standard', 'monomial-multiply', 'polynomial-def', 'polynomial-add-sub', 'mono-poly-mult', 'factoring-common', 'test-ch3']
  }
];
